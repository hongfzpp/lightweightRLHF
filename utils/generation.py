...
during PPO rollouts and evaluation. This is infrastructure code — NOT an exercise.

Note: This uses a simple Python loop over timesteps. For production, you'd use
jax.lax.while_loop for full XLA compilation, but the loop version is clearer
