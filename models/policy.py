...
This module wraps the GPT-2 model with RLHF-specific helper functions:
...
This is INFRASTRUCTURE code — NOT an exercise. It's provided because these
functions are used by multiple RLHF algorithms and getting the indexing
exactly right is fiddly but not algorithmically interesting.
"""
